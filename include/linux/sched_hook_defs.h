...
BPF_SCHED_HOOK(int, 0, detach_tasks_start, void)
BPF_SCHED_HOOK(int, 0, detach_tasks_end, void)
BPF_SCHED_HOOK(int, 0, detach_task_start, void)
BPF_SCHED_HOOK(int, 0, detach_task_end, void)
BPF_SCHED_HOOK(int, 0, detach_task_mid, void)
